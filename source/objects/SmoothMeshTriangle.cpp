...
SmoothMeshTriangle::SmoothMeshTriangle(std::shared_ptr<Mesh> mesh, int i1, int i2, int i3)
    : MeshTriangle(std::move(mesh), i1, i2, i3)
{
}
...
{
    Normal normal(
        (1 - beta - gamma) * mesh->normals[index0]
